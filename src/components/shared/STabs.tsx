...
export const STabs = TabsPrimitive.Root

export const STabsList = React.forwardRef<
...
STabsList.displayName = 'STabsList'

export const STabsTrigger = React.forwardRef<
...
STabsTrigger.displayName = 'STabsTrigger'

export const STabsContent = React.forwardRef<
...
STabsContent.displayName = 'STabsContent'
